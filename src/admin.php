    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <nav class="bg-white w-full flex relative justify-between items-center mx-auto px-8 h-20 border-b border-gray-200">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="index.php" class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700">
                    Back to Site
                </a>
        ...
        <div class="py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white p-6 rounded-lg shadow-sm border">
                    ...
                    <div class="space-y-3">
                        <a href="view_users.php" class="block w-full text-left px-4 py-2 bg-blue-50 hover:bg-blue-100 rounded-lg">
                            View All Users
                        </a>
                        <button class="block w-full text-left px-4 py-2 bg-green-50 hover:bg-green-100 rounded-lg">
                            Add New User
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border">
                    ...
                    <div class="space-y-3">
                        <a href="manage_all_products.php" class="block w-full text-left px-4 py-2 bg-purple-50 hover:bg-purple-100 rounded-lg">
                            Manage All Products
                        </a>
                        <a href="manage_products.php" class="block w-full text-left px-4 py-2 bg-blue-50 hover:bg-blue-100 rounded-lg">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border">
                    ...
                    <div class="space-y-3">
                        <button class="block w-full text-left px-4 py-2 bg-orange-50 hover:bg-orange-100 rounded-lg">
                            View Orders
                        </button>
                        <button class="block w-full text-left px-4 py-2 bg-red-50 hover:bg-red-100 rounded-lg">
                            Pending Orders
                        </button>
                    </div>
                </div>
